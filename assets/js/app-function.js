...
function submitForm() {
    ...
    if ($("#level").val() == 1) {
        ...
        const hVentWPerK = parseFloat($("#livingvolume").val()) * parseFloat($("#venti_global").val());
        depAeraulique=precise_round(hVentWPerK * deltaT,0);
        debug('Déperdition aéraulique : ' + depAeraulique + 'W (Hvent=' + hVentWPerK + ' W/K, ΔT=' + deltaT + 'K)');
        ...
        $("#thermal-study").append(
            ...
            + '<h6 data-toggle="tooltip" title="Volume * Venti (W/m3·K) * (Ti - Te)"><span data-i18n="[html]dep-aeraulique">Déperdition par aéraulique</span> : <span class="power-value" data-power-format="detailed" data-power-watts="'+depAeraulique+'">'+formatDetailedPowerText(depAeraulique)+'</span></h6>'
